	...
	return (
		<div className="w-full px-6">
			<div className="space-y-8 text-center">
				<div className="relative w-32 md:w-44 h-32 md:h-44 mx-auto">
				...
				<div className="space-y-3">
					<h1 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white">George Sopov</h1>
					...
					<p className="text-sm md:text-base text-gray-600 dark:text-gray-400 max-w-xs mx-auto leading-relaxed">
						Final-year Computer Science student with real-world production systems experience
					</p>
				</div>
				...
				<div className="space-y-20">
					...
					<div className="flex items-center justify-center space-x-2">
						...
						<a href="mailto:g.sopov@edu.salford.ac.uk" className="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white">
							g.sopov@edu.salford.ac.uk
						</a>
					</div>
					...
					<div className="flex items-center justify-center space-x-4 pt-2">
						<a
							href="https://github.com/RootGeorge17"
							target="_blank"
						...
						<a
							href="https://linkedin.com/in/georgesopov"
							target="_blank"
							rel="noopener noreferrer"
							className="p-2 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white"
						>
