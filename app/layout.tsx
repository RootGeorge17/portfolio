...
export const metadata: Metadata = {
	...
	authors: [{ name: 'George Sopov' }],
	creator: 'George Sopov',
	openGraph: {
		title: 'George Sopov - Developer Portfolio',
		description: 'Passionate developer creating simple and effective solutions. Explore my projects and development approach.',
		url: 'https://georgesopov.com',
		siteName: 'George Sopov - Portfolio',
		images: [
			{
				url: '/og-image.jpg',
				width: 1200,
				height: 630,
				alt: 'George Sopov - Developer Portfolio',
			},
		],
		locale: 'en_US',
		type: 'website',
